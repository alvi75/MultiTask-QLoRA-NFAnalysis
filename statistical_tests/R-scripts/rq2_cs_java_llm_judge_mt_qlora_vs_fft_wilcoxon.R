...
# Base path
base_path <- "/scratch/oldhome/mhaque/quantized-model-code-quality/statistical-tests/per-instance-value/llm_judge/java"
...
# ============== RAW OUTPUT ==============
sink(paste0(output_path, "/rq2_cs_java_llm_judge_mt_qlora_vs_fft_wilcoxon_RAW.txt"))

# QWEN 0.5B
print("********************** QWEN 0.5B: MT-QLoRA vs MT-FFT (Java LLM Judge) **********************")
...
# QWEN 1.5B
print("********************** QWEN 1.5B: MT-QLoRA vs MT-FFT (Java LLM Judge) **********************")
...
# QWEN 3B
print("********************** QWEN 3B: MT-QLoRA vs MT-FFT (Java LLM Judge) **********************")
...
# ============== CLEAN OUTPUT ==============
sink(paste0(output_path, "/rq2_cs_java_llm_judge_mt_qlora_vs_fft_wilcoxon_CLEAN.txt"))

cat("================================================================================\n")
cat("RQ2: Code Summarization - Java LLM Judge (MT-QLoRA vs MT-FFT) - Wilcoxon Test\n")
cat("================================================================================\n\n")
...
print(paste0(output_path, "/rq2_cs_java_llm_judge_mt_qlora_vs_fft_wilcoxon_RAW.txt"))
print(paste0(output_path, "/rq2_cs_java_llm_judge_mt_qlora_vs_fft_wilcoxon_CLEAN.txt"))