...
# ============== LOAD DATA ==============
# 3-task (CG+CS+CT)
data_3b_3task <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen3_mt_qlora.csv"), header=TRUE)
# 2-task combinations
data_3b_cg_cs <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen3_cg_cs_mt_qlora.csv"), header=TRUE)
data_3b_cs_ct <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen3_cs_ct_mt_qlora.csv"), header=TRUE)
...
# ============================================================================
sink(paste0(output_path, "/rq3_cs_python_3task_vs_2task_wilcoxon_RAW.txt"))

# ============== COMPARISON 1: 3-task vs CG+CS ==============
print("********************** QWEN 3B: MT-QLoRA (3-task) vs MT-QLoRA (CG+CS) (Python Summarization) *********************************")
...
print("********************** QWEN 3B: MT-QLoRA (3-task) vs MT-QLoRA (CS+CT) (Python Summarization) *********************************")
...
# ============================================================================
sink(paste0(output_path, "/rq3_cs_python_3task_vs_2task_wilcoxon_CLEAN.txt"))

cat("================================================================================\n")
cat("RQ3: Code Summarization - Python (3-task vs 2-task) - Wilcoxon Signed-Rank Test\n")
cat("================================================================================\n\n")
...
print(paste0(output_path, "/rq3_cs_python_3task_vs_2task_wilcoxon_RAW.txt"))
print(paste0(output_path, "/rq3_cs_python_3task_vs_2task_wilcoxon_CLEAN.txt"))