...
# ============== LOAD CODEBLEU DATA ==============
codebleu_0_5b_st <- read.csv(paste0(base_path, "/codebleu/translation/cs_java/ct_qwen0_5_st_qlora.csv"), header=TRUE)
codebleu_0_5b_mt <- read.csv(paste0(base_path, "/codebleu/translation/cs_java/ct_qwen0_5_mt_qlora.csv"), header=TRUE)
codebleu_1_5b_st <- read.csv(paste0(base_path, "/codebleu/translation/cs_java/ct_qwen1_5_st_qlora.csv"), header=TRUE)
codebleu_1_5b_mt <- read.csv(paste0(base_path, "/codebleu/translation/cs_java/ct_qwen1_5_mt_qlora.csv"), header=TRUE)
codebleu_3b_st <- read.csv(paste0(base_path, "/codebleu/translation/cs_java/ct_qwen3_st_qlora.csv"), header=TRUE)
codebleu_3b_mt <- read.csv(paste0(base_path, "/codebleu/translation/cs_java/ct_qwen3_mt_qlora.csv"), header=TRUE)

# ============== LOAD LIZARD DATA ==============
lizard_0_5b_st <- read.csv(paste0(base_path, "/lizard/translation/cs_java/r-lizard_ct_0_5b-st-qlora.csv"), header=TRUE)
lizard_0_5b_mt <- read.csv(paste0(base_path, "/lizard/translation/cs_java/r-lizard_ct_0_5b-mt-qlora.csv"), header=TRUE)
lizard_1_5b_st <- read.csv(paste0(base_path, "/lizard/translation/cs_java/r-lizard_ct_1_5b-st-qlora.csv"), header=TRUE)
lizard_1_5b_mt <- read.csv(paste0(base_path, "/lizard/translation/cs_java/r-lizard_ct_1_5b-mt-qlora.csv"), header=TRUE)
lizard_3b_st <- read.csv(paste0(base_path, "/lizard/translation/cs_java/r-lizard_ct_3b-st-qlora.csv"), header=TRUE)
lizard_3b_mt <- read.csv(paste0(base_path, "/lizard/translation/cs_java/r-lizard_ct_3b-mt-qlora.csv"), header=TRUE)

# ============== LOAD PMD DATA ==============
pmd_0_5b_st <- read.csv(paste0(base_path, "/pmd/translation/cs_java/r-pmd_ct_0_5b-st-qlora.csv"), header=TRUE)
pmd_0_5b_mt <- read.csv(paste0(base_path, "/pmd/translation/cs_java/r-pmd_ct_0_5b-mt-qlora.csv"), header=TRUE)
pmd_1_5b_st <- read.csv(paste0(base_path, "/pmd/translation/cs_java/r-pmd_ct_1_5b-st-qlora.csv"), header=TRUE)
pmd_1_5b_mt <- read.csv(paste0(base_path, "/pmd/translation/cs_java/r-pmd_ct_1_5b-mt-qlora.csv"), header=TRUE)
pmd_3b_st <- read.csv(paste0(base_path, "/pmd/translation/cs_java/r-pmd_ct_3b-st-qlora.csv"), header=TRUE)
pmd_3b_mt <- read.csv(paste0(base_path, "/pmd/translation/cs_java/r-pmd_ct_3b-mt-qlora.csv"), header=TRUE)

# ============== LOAD SONARCLOUD DATA ==============
sonar_0_5b_st <- read.csv(paste0(base_path, "/sonarcloud/translation/cs_java/r-sonarcloud_ct_qwen0_5_st_qlora.csv"), header=TRUE)
sonar_0_5b_mt <- read.csv(paste0(base_path, "/sonarcloud/translation/cs_java/r-sonarcloud_ct_qwen0_5_mt_qlora.csv"), header=TRUE)
sonar_1_5b_st <- read.csv(paste0(base_path, "/sonarcloud/translation/cs_java/r-sonarcloud_ct_qwen1_5_st_qlora.csv"), header=TRUE)
sonar_1_5b_mt <- read.csv(paste0(base_path, "/sonarcloud/translation/cs_java/r-sonarcloud_ct_qwen1_5_mt_qlora.csv"), header=TRUE)
sonar_3b_st <- read.csv(paste0(base_path, "/sonarcloud/translation/cs_java/r-sonarcloud_ct_qwen3_st_qlora.csv"), header=TRUE)
sonar_3b_mt <- read.csv(paste0(base_path, "/sonarcloud/translation/cs_java/r-sonarcloud_ct_qwen3_mt_qlora.csv"), header=TRUE)
...
# ============================================================================
sink(paste0(output_path, "/rq1_ct_cs_java_st_vs_mt_wilcoxon_RAW.txt"))

# ============== QWEN 0.5B ==============
print("********************** QWEN 0.5B: ST-QLoRA vs MT-QLoRA (C# to Java) *********************************")
...
# ============== QWEN 1.5B ==============
print("********************** QWEN 1.5B: ST-QLoRA vs MT-QLoRA (C# to Java) *********************************")
...
# ============== QWEN 3B ==============
print("********************** QWEN 3B: ST-QLoRA vs MT-QLoRA (C# to Java) *********************************")
...
# ============================================================================
sink(paste0(output_path, "/rq1_ct_cs_java_st_vs_mt_wilcoxon_CLEAN.txt"))

cat("================================================================================\n")
cat("RQ1: Code Translation - C# to Java (ST-QLoRA vs MT-QLoRA) - Wilcoxon Signed-Rank Test\n")
cat("================================================================================\n\n")
...
print(paste0(output_path, "/rq1_ct_cs_java_st_vs_mt_wilcoxon_RAW.txt"))
print(paste0(output_path, "/rq1_ct_cs_java_st_vs_mt_wilcoxon_CLEAN.txt"))