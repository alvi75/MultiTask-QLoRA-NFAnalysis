...
# ============== LOAD DATA ==============
# Qwen 0.5B
data_0_5b_qlora <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen0_5_mt_qlora.csv"), header=TRUE)
data_0_5b_fft <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen0_5_mt_fft.csv"), header=TRUE)

# Qwen 1.5B
data_1_5b_qlora <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen1_5_mt_qlora.csv"), header=TRUE)
data_1_5b_fft <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen1_5_mt_fft.csv"), header=TRUE)

# Qwen 3B
data_3b_qlora <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen3_mt_qlora.csv"), header=TRUE)
data_3b_fft <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen3_mt_fft.csv"), header=TRUE)
...
# ============================================================================
sink(paste0(output_path, "/rq2_cs_python_mt_qlora_vs_fft_wilcoxon_RAW.txt"))

# ============== QWEN 0.5B ==============
print("********************** QWEN 0.5B: MT-QLoRA vs MT-FFT (Python Summarization) *********************************")
...
# ============== QWEN 1.5B ==============
print("********************** QWEN 1.5B: MT-QLoRA vs MT-FFT (Python Summarization) *********************************")
...
# ============== QWEN 3B ==============
print("********************** QWEN 3B: MT-QLoRA vs MT-FFT (Python Summarization) *********************************")
...
# ============================================================================
sink(paste0(output_path, "/rq2_cs_python_mt_qlora_vs_fft_wilcoxon_CLEAN.txt"))

cat("================================================================================\n")
cat("RQ2: Code Summarization - Python (MT-QLoRA vs MT-FFT) - Wilcoxon Signed-Rank Test\n")
cat("================================================================================\n\n")

# Metric labels
metric_labels <- c("BLEU", "METEOR", "Rouge-L", "chrF", "BERTScore")
...
print(paste0(output_path, "/rq2_cs_python_mt_qlora_vs_fft_wilcoxon_RAW.txt"))
print(paste0(output_path, "/rq2_cs_python_mt_qlora_vs_fft_wilcoxon_CLEAN.txt"))