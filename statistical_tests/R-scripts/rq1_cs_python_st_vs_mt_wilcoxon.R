...
# ============== LOAD DATA ==============
# Qwen 0.5B
data_0_5b_st <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen0_5_st_qlora.csv"), header=TRUE)
data_0_5b_mt <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen0_5_mt_qlora.csv"), header=TRUE)

# Qwen 1.5B
data_1_5b_st <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen1_5_st_qlora.csv"), header=TRUE)
data_1_5b_mt <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen1_5_mt_qlora.csv"), header=TRUE)

# Qwen 3B
data_3b_st <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen3_st_qlora.csv"), header=TRUE)
data_3b_mt <- read.csv(paste0(base_path, "/bleu_meteor_rouge_chrf_bertscore_side/summarization/py/cs_qwen3_mt_qlora.csv"), header=TRUE)
...
# ============================================================================
sink(paste0(output_path, "/rq1_cs_python_st_vs_mt_wilcoxon_RAW.txt"))

# ============== QWEN 0.5B ==============
print("********************** QWEN 0.5B: ST-QLoRA vs MT-QLoRA (Python Summarization) *********************************")
...
# ============== QWEN 1.5B ==============
print("********************** QWEN 1.5B: ST-QLoRA vs MT-QLoRA (Python Summarization) *********************************")
...
# ============== QWEN 3B ==============
print("********************** QWEN 3B: ST-QLoRA vs MT-QLoRA (Python Summarization) *********************************")
...
# ============================================================================
sink(paste0(output_path, "/rq1_cs_python_st_vs_mt_wilcoxon_CLEAN.txt"))

cat("================================================================================\n")
cat("RQ1: Code Summarization - Python (ST-QLoRA vs MT-QLoRA) - Wilcoxon Signed-Rank Test\n")
cat("================================================================================\n\n")
...
print(paste0(output_path, "/rq1_cs_python_st_vs_mt_wilcoxon_RAW.txt"))
print(paste0(output_path, "/rq1_cs_python_st_vs_mt_wilcoxon_CLEAN.txt"))