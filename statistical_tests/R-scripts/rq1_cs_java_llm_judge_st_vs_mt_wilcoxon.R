...
# ============== RAW OUTPUT ==============
sink(paste0(output_path, "/rq1_cs_java_llm_judge_st_vs_mt_wilcoxon_RAW.txt"))

# QWEN 0.5B
print("********************** QWEN 0.5B: ST-QLoRA vs MT-QLoRA (Java LLM Judge) **********************")
...
# QWEN 1.5B
print("********************** QWEN 1.5B: ST-QLoRA vs MT-QLoRA (Java LLM Judge) **********************")
...
# QWEN 3B
print("********************** QWEN 3B: ST-QLoRA vs MT-QLoRA (Java LLM Judge) **********************")
...
# ============== CLEAN OUTPUT ==============
sink(paste0(output_path, "/rq1_cs_java_llm_judge_st_vs_mt_wilcoxon_CLEAN.txt"))

cat("================================================================================\n")
cat("RQ1: Code Summarization - Java LLM Judge (ST-QLoRA vs MT-QLoRA) - Wilcoxon Test\n")
cat("================================================================================\n\n")
...
print(paste0(output_path, "/rq1_cs_java_llm_judge_st_vs_mt_wilcoxon_RAW.txt"))
print(paste0(output_path, "/rq1_cs_java_llm_judge_st_vs_mt_wilcoxon_CLEAN.txt"))