...
# ============== LOAD LIZARD DATA ==============
lizard_0_5b_qlora <- read.csv(paste0(base_path, "/lizard/generation/java/r-lizard_cg_0_5b-mt-qlora.csv"), header=TRUE)
lizard_0_5b_fft <- read.csv(paste0(base_path, "/lizard/generation/java/r-lizard_cg_0_5b-mt-fft.csv"), header=TRUE)
lizard_1_5b_qlora <- read.csv(paste0(base_path, "/lizard/generation/java/r-lizard_cg_1_5b-mt-qlora.csv"), header=TRUE)
lizard_1_5b_fft <- read.csv(paste0(base_path, "/lizard/generation/java/r-lizard_cg_1_5b-mt-fft.csv"), header=TRUE)
lizard_3b_qlora <- read.csv(paste0(base_path, "/lizard/generation/java/r-lizard_cg_3b-mt-qlora.csv"), header=TRUE)
lizard_3b_fft <- read.csv(paste0(base_path, "/lizard/generation/java/r-lizard_cg_3b-mt-fft.csv"), header=TRUE)

# ============== LOAD PMD DATA ==============
pmd_0_5b_qlora <- read.csv(paste0(base_path, "/pmd/generation/r-pmd_cg_0_5b-mt-qlora.csv"), header=TRUE)
pmd_0_5b_fft <- read.csv(paste0(base_path, "/pmd/generation/r-pmd_cg_0_5b-mt-fft.csv"), header=TRUE)
pmd_1_5b_qlora <- read.csv(paste0(base_path, "/pmd/generation/r-pmd_cg_1_5b-mt-qlora.csv"), header=TRUE)
pmd_1_5b_fft <- read.csv(paste0(base_path, "/pmd/generation/r-pmd_cg_1_5b-mt-fft.csv"), header=TRUE)
pmd_3b_qlora <- read.csv(paste0(base_path, "/pmd/generation/r-pmd_cg_3b-mt-qlora.csv"), header=TRUE)
pmd_3b_fft <- read.csv(paste0(base_path, "/pmd/generation/r-pmd_cg_3b-mt-fft.csv"), header=TRUE)

# ============== LOAD SONARCLOUD DATA ==============
sonar_0_5b_qlora <- read.csv(paste0(base_path, "/sonarcloud/generation/java/r-sonarcloud_cg_qwen0_5_mt_qlora.csv"), header=TRUE)
sonar_0_5b_fft <- read.csv(paste0(base_path, "/sonarcloud/generation/java/r-sonarcloud_cg_qwen0_5_mt_fft.csv"), header=TRUE)
sonar_1_5b_qlora <- read.csv(paste0(base_path, "/sonarcloud/generation/java/r-sonarcloud_cg_qwen1_5_mt_qlora.csv"), header=TRUE)
sonar_1_5b_fft <- read.csv(paste0(base_path, "/sonarcloud/generation/java/r-sonarcloud_cg_qwen1_5_mt_fft.csv"), header=TRUE)
sonar_3b_qlora <- read.csv(paste0(base_path, "/sonarcloud/generation/java/r-sonarcloud_cg_qwen3_mt_qlora.csv"), header=TRUE)
sonar_3b_fft <- read.csv(paste0(base_path, "/sonarcloud/generation/java/r-sonarcloud_cg_qwen3_mt_fft.csv"), header=TRUE)
...
# ============================================================================
sink(paste0(output_path, "/rq2_cg_java_mt_qlora_vs_fft_wilcoxon_RAW.txt"))

# ============== QWEN 0.5B ==============
print("********************** QWEN 0.5B: MT-QLoRA vs MT-FFT (Java) *********************************")
...
# ============== QWEN 1.5B ==============
print("********************** QWEN 1.5B: MT-QLoRA vs MT-FFT (Java) *********************************")
...
# ============== QWEN 3B ==============
print("********************** QWEN 3B: MT-QLoRA vs MT-FFT (Java) *********************************")
...
# ============================================================================
sink(paste0(output_path, "/rq2_cg_java_mt_qlora_vs_fft_wilcoxon_CLEAN.txt"))

cat("================================================================================\n")
cat("RQ2: Code Generation - Java (MT-QLoRA vs MT-FFT) - Wilcoxon Signed-Rank Test\n")
cat("================================================================================\n\n")
...
print(paste0(output_path, "/rq2_cg_java_mt_qlora_vs_fft_wilcoxon_RAW.txt"))
print(paste0(output_path, "/rq2_cg_java_mt_qlora_vs_fft_wilcoxon_CLEAN.txt"))